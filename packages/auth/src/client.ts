...
export type { AuthClientOptions } from "./types.js";

/** RPC operation names, verbatim from component-spec.md's operation table. */
const OP = {
...
export function createAuthClient(
  ...
  const channel =
    options.crossTab === false
      ? noopCrossTabChannel()
      : crossTabChannel(`singlebase-auth:${options.urlAccessKey}`);
