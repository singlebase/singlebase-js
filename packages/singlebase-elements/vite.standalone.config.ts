 ...
 * Lit, core and the SDK — inlined into one minified file with no bare imports
 * to resolve, so it works from a CDN with no bundler and no import map.
 *
...
export default defineConfig({
  ...
  build: {
    ...
    lib: {
      ...
      fileName: () => "singlebase-elements.min.js",
      formats: ["es"]
    },
    minify: "esbuild",
    sourcemap: true,
